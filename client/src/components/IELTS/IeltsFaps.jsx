...
const IeltsFaqs = () => {
  ...
  return (
    <section className="w-auto h-auto min-h-[968px] gap-[32px] py-[48px] bg-white px-16 mb-32">
      <div className="mx-10">
        <div className="flex items-center justify-center flex-col space-y-5">
          <h1 className="text-[#092962] text-[40px] font-semibold">FAQs</h1>
