...
const HelpingYou = () => {
  return (
    <section className="w-full h-auto bg-white py-8 sm:py-10 md:py-12 lg:py-16">
      <div className="px-4 sm:px-6 md:px-10 lg:px-20">
        <div className="w-full h-auto flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-12">
          ...
          {/* Right Image */}
          <div className="w-full lg:w-1/2 rounded-[9.75px] h-[280px] sm:h-[350px] md:h-[400px] lg:h-[477px] mt-0 lg:mt-5 overflow-hidden flex-shrink-0">
            <img
              src={boy}
