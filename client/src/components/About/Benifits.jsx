...
const Benifits = () => {
  ...
  return (
    <section className="w-auto h-auto bg-white py-[48px] ">
      <div className="mx-28 gap-[28px] space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 justify-items-center">
          {cards.map((item) => (
            <div
              key={item.id}
              className="bg-[#021A54] rounded-lg shadow-lg overflow-hidden w-[300px] h-[385px] mt-5"
            >
              {/* Image Section */}
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-center flex-col px-5 space-y-2 mt-5">
                  <h3 className="text-xl font-bold text-white text-center">
                    {item.title}
                  </h3>
                  <p className="text-[#74BF1A] text-sm leading-relaxed text-center">
                    {item.p1}
                  </p>
