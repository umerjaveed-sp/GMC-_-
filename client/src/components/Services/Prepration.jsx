      ...
      <div className="w-full max-w-[1440px] mx-auto gap-4 sm:gap-6 md:gap-[28px] space-y-4 sm:space-y-5 md:space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-[65px]">
          ...
          <div className="w-full lg:w-[608px] h-auto gap-4 sm:gap-5 md:gap-6 space-y-4 sm:space-y-5">
            <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[405.83px] bg-gray-300 rounded-[9.75px] overflow-hidden">
              <img
                src={prepration}
          ...
          <div className="w-full lg:w-[566px] h-auto gap-4 sm:gap-5 md:gap-[24px]">
            <div className="w-full h-auto lg:h-[587px] rounded-[16px] border-[0.5px] pt-6 sm:pt-8 px-4 sm:px-5 md:px-6 pb-6 sm:pb-8 gap-6 sm:gap-8 bg-white">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-neutral-900 leading-snug">
                Have Questions? Get in <br className="hidden sm:block" /> Touch!
              </h2>
            ...
            <div className="w-full lg:w-[550px] h-auto mt-4 sm:mt-5 flex items-center justify-center cursor-pointer">
              <div className="text-[#092962] font-semibold underline text-sm sm:text-base hover:text-[#74BF1A] transition-colors">
